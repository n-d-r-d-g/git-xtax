...
measure_command_time: bool = os.environ.get('GIT_XTAX_MEASURE_COMMAND_TIME') == 'true'  # undocumented, internal
...
def get_cmd_shell_repr(cmd: str, *args: str, env: Optional[Dict[str, str]]) -> str:
    ...
    # We don't want to include the env vars that are inherited from the environment of git-xtax process
